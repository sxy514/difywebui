...
export type IWelcomeProps = {
  ...
  onStartChat: (inputs: Record<string, any>, message?: string) => void
...
const Welcome: FC<IWelcomeProps> = ({
  ...
  const [recommendedQuestion, setRecommendedQuestion] = useState<string | null>(null)
  ...
  return (
    <div className='relative mobile:min-h-[48px] tablet:min-h-[64px]'>
      ...
      <div className='mx-auto pc:w-[794px] max-w-full mobile:w-full px-3.5'>
        ...
        {!hasSetInputs && (
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-700 mb-2">推荐问题</h3>
            <div className="grid grid-cols-1 gap-2">
              {[
                ...
                <div
                  key={index}
                  className="text-sm text-primary-600 cursor-pointer hover:underline p-2 bg-gray-50 rounded-md"
        ...
        {!hasSetInputs && (
          <div className='mt-4 flex justify-between items-center h-8 text-xs text-gray-400'>
            ...
            <div className="text-gray-500">
              ...
              <span className="text-gray-500">{t('app.chat.privacyPolicyMiddle')}</span>
              {t('app.chat.privacyPolicyRight')}
            </div>
            {/* Hidden 'Powered by Dify' text
