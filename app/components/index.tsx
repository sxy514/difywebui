...
const Main: FC<IMainProps> = () => {
  ...
  */
  ...
  const handleStartChat = (inputs: Record<string, any>, message?: string) => {
    createNewChat()
    ...
    sendChatMessage(data, {
      ...
      async onCompleted(hasError?: boolean) {
        ...
        if (getConversationIdChangeBecauseOfNew()) {
          ...
          // Get the first message from the conversation to use for name generation
          const firstMessage = getChatList().find(item => item.isAnswer === false)?.content || ''
          const newItem: any = await generationConversationName(
            allConversations[0].id,
            firstMessage, // Pass the first message to help generate a more specific name
          )
  ...
  return (
    <div className='h-screen flex flex-col bg-white overflow-hidden'>
      ...
      <div className='flex flex-1 overflow-hidden'>
        {/* Sidebar - Desktop */}
        {!isMobile && (
          <div className='w-72 flex-shrink-0 h-full border-r border-gray-200'>
            <Sidebar
        ...
        {isMobile && isShowSidebar && (
          <div className='fixed inset-0 z-40 flex' style={{ backgroundColor: 'rgba(35, 56, 118, 0.5)' }}>
            ...
            <div className='flex-1' onClick={hideSidebar}></div>
          </div>
        )}
